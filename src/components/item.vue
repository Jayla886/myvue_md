			...
			<div class="row">
				...
				<div class="col-md-6 mt-5 mt-md-2 text-center text-md-left">
					...
					<ul>
						...
						<li v-for="(index,item) in commentlist" :key="index" >
...
export default {
  ...
  methods:{
  	...
  	submit:function(){
  		...
  		//请求入库
  		//发送请求
      this.axios.post('http://172.16.171.131:8000/commentinsert/',this.qs.stringify({uid:localStorage.getItem("uid"),gid:this.id,content:this.comment})).then((result) =>{
